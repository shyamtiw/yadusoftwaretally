<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="TallyGroupOutstanding.aspx.cs" Inherits="WebApp.admin.TallyGroupOutstanding" %>
            ...
            <div class="box box-success box-solid" style="border: 3px solid #0b0336!important;">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <asp:Literal runat="server" ID="DIVGroupNames"></asp:Literal>
                            ...
                            <asp:DropDownList runat="server" ID="GroupNames" CssClass="form-control">
                                ...
                                <asp:ListItem Value="NavyGEN-Branch-Division">NavyGEN-Branch-Division</asp:ListItem>
                                <asp:ListItem Value="NavyGEN-Debtors Booking">NavyGEN-Debtors Booking</asp:ListItem>

                            </asp:DropDownList>
                        </div>


                    <asp:Literal runat="server" ID="DIVISBillToBill"></asp:Literal>
                            <label>Export Type</label>
                            <asp:DropDownList runat="server" ID="ReportType" CssClass="form-control">
                                <asp:ListItem Value="GroupWise">Ledger  Wise </asp:ListItem>
                                <asp:ListItem Value="BillToBill">Bill Wise</asp:ListItem>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Script" runat="server">
    ...
    <script type="text/javascript">  
       $(document).ready(function () {
           $("#<%=BranchId.ClientID%>").SumoSelect({ selectAll: true });

           $('#<%=BranchId.ClientID%>').on('sumo:opening', function () {
