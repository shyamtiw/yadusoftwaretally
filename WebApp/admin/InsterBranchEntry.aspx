<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="InsterBranchEntry.aspx.cs" Inherits="WebApp.admin.InsterBranchEntry" %>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table" id="maintable" style="width: 100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr style="    border-top: 1px solid #f4f4f4;border-bottom: 2px solid #f4f4f4;">
                <th colspan="2" style="text-align:right">Voucher Total:</th>
                <td><strong><asp:Label BackColor="WhiteSmoke" runat="server" ID="TotalAmount"></asp:Label></strong></td>
<td colspan="3"></td>
