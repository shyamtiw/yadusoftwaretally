<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="ImportExcelForUpdateTallyPurchase.aspx.cs" Inherits="WebApp.admin.ImportExcelForUpdateTallyPurchase" %>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-success box-solid" style="border: 3px solid #0b0336!important;">
                        <div class="box-header with-border" style="background: #0b0336!important; background-color: #0b0336!important;">
                            <h3 class="box-title">Import Update Tally Purchase</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
