<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUploader.aspx.cs" Inherits="WebApp.admin.FileUploader" %>
...
function onUploadClick() {
    ...
    onComplete(MessageStatus.Warning, 'You need to select a file.', '', '0 of 0 Bytes');
        ...
        function updateMessage(type, message, filename, downloadBytes) {
            ...
            $get('vals').value = filename;
            
            $get('dvFileName').innerHTML = filename + "<a  onclick='SetNameCloseBotton()' class='button button2'> Use This</>";
...
<body>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2" style="width: 17%" align="center">
                                                                                ...
                                                                                <a  href="#" onclick="SetName(<%# Eval("Name","'{0}'") %>)" ><img  width="15"  src="Images/usefile.png" /></a>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SetNameCloseBotton() {
            debugger;
            if (window.opener != null && !window.opener.closed) {
                var txtName = window.opener.document.getElementById("FromContener_StuclsIds");
                txtName.value = $get('vals').value;
                txtName.onchange();
