...
namespace WebApp.admin
{
    public partial class FileUploader : System.Web.UI.Page
    {
        ...
        protected void gvNewFiles_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            //    SiteSession.FilterKeyHolder.Add(new FilterKeyHolder() { Key = Ids, Value = e.CommandArgument.ToString() });
            //    System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Successfully", "window.close();window.location='" + Request.QueryString["fromkey"] + ".aspx?key=" + Ids + "'", true);
            //}
        ...
        public DataTable GetFilesInDirectory(string sourcePath)
        {
            ...
            string FilterName=  "!" + LIBS.SiteSession.Comp_MstSession.Comp_Code;
            if ((Directory.Exists(sourcePath)))
            {
                ...
                {
                    if (files.Name.Contains(FilterName))
                    {
