<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="frmAutoDebitImport.aspx.cs" Inherits="WebApp.admin.frmAutoDebitImport" %>
                ...
                <div class="col-md-6" style="float:none;margin:auto;">
                    ...
                    <div class="box box-success box-solid" style="border: 3px solid #0b0336!important;">
                        <div class="box-header with-border" style="background: #0b0336!important; background-color: #0b0336!important;">
                            <h3 class="box-title">Import Auto Insurance</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
