<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="E_IndusvalinsuranceList.aspx.cs" Inherits="WebApp.admin.E_IndusvalinsuranceList" %>
                                ...
                                <asp:GridView ID="gvlocation"  Style='width: 100%' CssClass='t02 t01' HeaderStyle-BackColor="LightBlue" runat="server" AutoGenerateColumns="false" Width="98%" align="center">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CreateDate">
                                            <ItemTemplate><%# Convert.ToDateTime( Eval("CreateDate")).ToString("dd/MM/yyyy")%> </ItemTemplate>
                                        </asp:TemplateField>
                                       
                                        <asp:TemplateField HeaderText="Vehicle Regn No.">
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <a onclick="<%# Eval("ECoupanEntryId","showLeter('ECoupanEntry.aspx?ECoupanEntryId={0}')") %>" class="label label-sm label-info">Update Entry</a>                          
                                                <a onclick="<%# Eval("ECoupanEntryId","showLeter('E_AddInsuranceCoupon.aspx?ECoupanEntryId={0}')") %>" class="label label-sm label-danger">Coupon</a>                          
                                            </ItemTemplate>
                                        </asp:TemplateField>
