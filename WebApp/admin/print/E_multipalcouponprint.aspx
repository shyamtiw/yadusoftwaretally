<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="E_multipalcouponprint.aspx.cs" Inherits="WebApp.admin.print.E_multipalcouponprint" %>
        ...
        <div class="topdiv"  style="text-align:left;margin-right:5px">
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 100%">
                        <h4 style="text-align: center">||COUPON(<%# Eval("Master.Name") %>)||</h4>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 40%">
                                   <p><b>Customer Name :</b><u class="dotted"> <%# Eval("ECoupanEntry.CustomerName") %></u></p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: left;"><b>Mobile No. :</b><u class="dotted"> <%# Eval("MobNo") %></u> </p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: right;"><b>Regn No. :</b><u class="dotted"><%# Eval("ECoupanEntry.VehicleRegnNo") %></u> </p>
                                </td>
                            </tr>
                        </table>
                  <table style="width: 100%">
