<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="multipalcouponprint.aspx.cs" Inherits="WebApp.admin.print.multipalcouponprint" %>
        ...
        <div class="topdiv"  style="text-align:left;margin-right:5px">
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 100%">
                        <h4 style="text-align: center">||INSURANCE COUPON(<%# Eval("Master.Name") %>)||</h4>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <p style="text-align: right;"><b>Valid upto </b>:<u class="dotted"><%# Convert.ToDateTime( Eval("InsuranceIndividual.PolicyExpiryDate")).ToString("dd/MM/yyyy") %></u></p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 40%">
                                   <p><b>Customer Name :</b><u class="dotted"> <%# Eval("InsuranceIndividual.CustomerName") %></u></p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: left;"><b>Mobile No. :</b><u class="dotted"> <%# Eval("MobNo") %></u> </p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: right;"><b>Regn No. :</b><u class="dotted"><%# Eval("InsuranceIndividual.VehicleRegnNo") %></u> </p>
                                </td>
                            </tr>
                        </table>
                  <table style="width: 100%">
                            <tr>
                                <td style="width: 40%">
                                   <p><b>Advisor Name:</b><u class="dotted"><%# Eval("InsuranceIndividual.DealersExecutive") %></u></p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: left;"><b>Chassis No.:</b><u class="dotted"><%# Eval("InsuranceIndividual.ChassisNo") %></u> </p>
                                </td>
                                <td style="width: 20%">
                                     <p  style="text-align: right;"><b>Engine No. :</b><u class="dotted"> <%# Eval("InsuranceIndividual.EngineNo") %></u> </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <p style="text-align: center; padding-bottom: 0px">||<%# Eval("Master.Description") %>||</p>
                           <br />
                        <br />
                           <%--<svg id="barcode"></svg>--%>
                           <br />
