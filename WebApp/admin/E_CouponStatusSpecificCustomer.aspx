<%@ Page Title="" Language="C#" MasterPageFile="~/admin/popup.Master" AutoEventWireup="true" CodeBehind="E_CouponStatusSpecificCustomer.aspx.cs" Inherits="WebApp.admin.E_CouponStatusSpecificCustomer" %>
                                                        ...
                                                        <div class="col-md-12" style="display:none">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <input type="text" id="OTPFrom" value="123" class="form-control" />
    ...
    <script>
        ...
        function SendOTP() {
            $.ajax({
                ...
                type: "POST",
                url: 'E_CouponStatusSpecificCustomer.aspx/sendopt',
        ...
        function SaveData() {
            ...
            if (document.getElementById("OTPFrom").value.length > 0 && document.getElementById("InvoiceNo").value.length > 0) {
                $.ajax({
                    ...
                    type: "POST",
                    url: 'E_CouponStatusSpecificCustomer.aspx/savedata',
