<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="FinanceDataList.aspx.cs" Inherits="WebApp.admin.FinanceDataList" %>
            ...
            <h3 class="box-title" style="color:white">Data List</h3>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <asp:DropDownList runat="server" ID="Status" class="form-control">
                            ...
                            <asp:ListItem Text="Payout Pending" Value="Payout Pending">
                            </asp:ListItem>
                            <asp:ListItem Text="Payout Received" Value="Payout Received">
                            </asp:ListItem>
                             <asp:ListItem Text="Payment Pending" Value="Payment Pending">
                            </asp:ListItem>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <asp:TextBox     runat="server" CssClass="form-control" ID="FromDate" placeholder="From Date" TextMode="Date"></asp:TextBox>
                    </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label>To Date</label>
                        <asp:TextBox   runat="server" CssClass="form-control" ID="ToDate" placeholder="To Date" TextMode="Date"></asp:TextBox>
                ...
                <div class="col-md-2">
                        ...
                        <div class="input-group">
                           <table>
                               <tr>
                                   <td style="width:80%">   <asp:TextBox   runat="server" CssClass="form-control" placeholder="Search....." ID="txtSearch" class="form-control"></asp:TextBox></td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Script" runat="server">
    ...
    <script>
        ...
        function SearchTerm() {
            return jQuery.trim($("#<%=txtSearch.ClientID%>").val());
        };
        ...
        function GetCustomers(pageIndex, name) {
            ...
            obj.FilterbyDt = $.trim($("#<%=FilterbyDt.ClientID%>").val());
            

            $.ajax({
                type: "POST",
                url: "FinanceDataList.aspx/GetCustomers",
        ...
        function printinvoice(str) {
            ...
            var left = (screen.width - wird) / 2; var top = (screen.height - 600) / 4;

            var popup = window.open("UpdateFinanceData.aspx?ReceiptId=" + str.toString() + "", "Print Receipt", 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + wird + ', height=' + 600 + ', top=' + top + ', left=' + left);
            popup.focus();
        }
