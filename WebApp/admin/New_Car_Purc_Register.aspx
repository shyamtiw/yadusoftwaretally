<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="New_Car_Purc_Register.aspx.cs" Inherits="WebApp.admin.New_Car_Purc_Register" %>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-success box-solid" style="border: 3px solid #0b0336!important;">
                        <div class="box-header with-border" style="background: #0b0336!important; background-color: #0b0336!important;">
                            <h3 class="box-title">New Car Purchase Register</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="box-footer">
                                <asp:Button runat="server" Text="Upload" OnClick="saveAccountHead_Click" ID="saveAccountHead" ValidationGroup="head" CssClass="btn btn-primary" />
                            </div>
