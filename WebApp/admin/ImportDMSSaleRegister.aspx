                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ImportFileType" CssClass="form-control">
                                            ...
                                            <asp:ListItem Text="Import DMS Maruti Suzuki Rewards" Value="39"></asp:ListItem>
                                            <asp:ListItem Text="Import MSILWarrantyClaim" Value="40"></asp:ListItem>
                                            <asp:ListItem Text="Import MI Date from BI Sale Register" Value="41"></asp:ListItem>
                                            <asp:ListItem Text="Import MFG Year from Indiviudal Report" Value="42"></asp:ListItem>
                                            <asp:ListItem Text="Import DMS STO Taxable value" Value="43"></asp:ListItem>
                                            <asp:ListItem Text="Import DMS STI Taxable value" Value="44"></asp:ListItem>

                                            <asp:ListItem Text="DPS SMR Import" Value="45"></asp:ListItem>
                                              <asp:ListItem Text="DPS MI Import" Value="46"></asp:ListItem>
                                            <asp:ListItem Text="DPS PSF Import" Value="47"></asp:ListItem>
                                            <asp:ListItem Text="CRM DPSDUMP" Value="48"></asp:ListItem>
                                            <asp:ListItem Text="Import loyalty card" Value="49"></asp:ListItem>
