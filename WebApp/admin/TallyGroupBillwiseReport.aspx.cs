...
{
    public partial class TallyGroupBillwiseReport : System.Web.UI.Page
    {
                        ...
                        if (GroupNameList.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow Item in GroupNameList.Rows)
                            {
                                ...
                                for (int i = 0; i < DtLedger.Rows.Count; i++)
                                {
                                    ...
                                    dr["Opening"] = ds.Tables["BILLOP"].Rows[i][0].ToString();
                                    dr["Closing"] = ds.Tables["BILLCL"].Rows[i][0].ToString();
