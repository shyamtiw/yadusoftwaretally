...
<body class="hold-transition login-page" style="background: #ffffff;">
    <div class="login-box" style="margin: 1% auto!important;">
        ...
        <div class="login-box-body">
            <h3 class="login-box-msg">Login to start your session</h3>
            ...
            <form runat="server" id="form1">
                ...
                <div class="box box-success box-solid" style="border: 3px solid #0b0336!important;">
                    <div class="box-header with-border" style="background: #0b0336!important; background-color: #0b0336!important;">
                      <center>  <h3 class="box-title" style="text-align:center">AUTO-VYN  Cloud </h3></center>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            <asp:Label runat="server" ID="message"></asp:Label>
                <div class="form-group has-feedback">
                    <asp:TextBox runat="server" placeholder="User Name" class="form-control" ID="Email"></asp:TextBox><br />
                    <asp:TextBox runat="server" placeholder="Password" TextMode="Password" class="form-control" ID="Password"></asp:TextBox><br />
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <asp:Button runat="server" ID="loginbtn" Text="Login In" class="btn btn-primary btn-block btn-flat" OnClick="login_Click" />
                    </div>
                    <!-- /.col -->
                </div>
                    </div>
