...
{
    public partial class Service_Performance : BasePageClassMobile
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Load1920.Text = ((int)System.Math.Ceiling(TotLoad1920)).ToString();
                Load2021.Text = ((int)System.Math.Ceiling(TotLoad2021)).ToString();
                Load2122.Text = ((int)System.Math.Ceiling(TotLoad2122)).ToString();
