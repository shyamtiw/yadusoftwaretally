...
{
    public partial class Booking_Dashbaord : BasePageClassMobile
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dt = MobileSales.BookingDashboarddata();

                Pending_Booking.Text = dt.Rows[0]["Pending_Booking"].ToString();
                Send_For_Approval.Text = dt.Rows[0]["Pending_For_Approval"].ToString();
                Discount_Approved.Text = dt.Rows[0]["Discount_Approved"].ToString();
                Discount_Rejected.Text = dt.Rows[0]["Discount_Rejected"].ToString(); 
                Pending_Booking1.Text = dt.Rows[0]["Pending_Booking"].ToString();
                Send_For_Approval1.Text = dt.Rows[0]["Pending_For_Approval"].ToString();
