<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booking_Dashbaord.aspx.cs" Inherits="WebApp.mobile.Booking_Dashbaord" %>
...
<head>
    ...
    <title>DSE Booking Portal</title>
...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="section">
            <div class="row mt-2">
                <div class="col-6">
                    <a href="Pending_Booking.aspx">
                        <div class="stat-box">
                            <div class="title">Pending Booking</div>
                            <div class="value text-success">
                                <asp:Literal runat="server" ID="Pending_Booking"></asp:Literal>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-6">
                    <a href="Pending_Booking.aspx?status=2">
                        <div class="stat-box">
                            <div class="title">Send For Approval </div>
                            <div class="value text-danger">
                                <asp:Literal runat="server" ID="Send_For_Approval"></asp:Literal>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <a href="Pending_Booking.aspx?status=4">
                        <div class="stat-box">
                ...
                <div class="col-6">
                    <a href="Pending_Booking.aspx?status=3">
                        <div class="stat-box">
                        ...
                        <li>
                            <a href="Pending_Booking.aspx" class="item">
                                ...
                                <div class="in">
                                    ...
                                    <span class="badge badge-primary"><asp:Literal runat="server" ID="Pending_Booking1"></asp:Literal></span>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="Pending_Booking.aspx" class="item">
                                ...
                                <div class="in">
                                    Send for Approval
                                <span class="badge badge-primary"><asp:Literal runat="server" ID="Send_For_Approval1"></asp:Literal></span>
                                </div>
                            </a>
                        </li>
                        <li>
