<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mobile_Home.aspx.cs" Inherits="WebApp.mobile.Mobile_Home" %>
...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-4">
            ...
            <div class="transactions" style="padding-top: 10px!important">
                <!-- item -->
                <a href="HR_Home.aspx" class="item">
                    <div class="detail">
                        <img src="assets/img/Sample/brand/HR.png" alt="img" class="image-block imaged w10">
                        <div>
