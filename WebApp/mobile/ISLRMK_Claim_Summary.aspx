<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ISLRMK_Claim_Summary.aspx.cs" Inherits="WebApp.mobile.ISLRMK_Claim_Summary" %>
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs style1" role="tablist">
                            <asp:Repeater runat="server" ID="Repeater3">
                                <ItemTemplate>
                                    <li class="nav-item">
                                        <a href="<%# string.Concat("ISLRMK_Claim_Summary.aspx?Region=",Eval("Region")) %>" class="nav-link active"><strong><%# Eval("Region")  %> </strong></a>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <asp:Repeater runat="server" ID="ISLRMK_Claim_Data">
                            <ItemTemplate>
                                <tr>
                                    

                                    <th scope="row">  <a href=ISL_CLAIM_Detail.aspx class="item"><%# Eval("Month") %></a></th>
                                    <td>
                        ...
                        <tr class="table-primaryBlue">
                            ...
                            <th scope="col" style="color: white;">
                                <asp:Label ID="GTISLRMK" runat="server" /></th>
                        </tr>
                    </tbody>
                </table>
            </div>
