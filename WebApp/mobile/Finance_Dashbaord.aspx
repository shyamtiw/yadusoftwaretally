<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Finance_Dashbaord.aspx.cs" Inherits="WebApp.mobile.Finance_Dashbaord" %>
    ...
    <div id="appCapsule">
        ...
        <div class="section wallet-card-section pt-1">
            <div class="wallet-card">
                ...
                <div class="balance">
                    <div class="left">
                        <span class="title">Total Finance</span>
            ...
            <div class="row mt-2">
                <div class="col-6">
                    ...
                    <a href="app-Employee-Master.aspx">
                        ...
                        <div class="stat-box">
                            ...
                            <div class="value text-success">Booking</div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-6">
                    <a href="Edit-Employee.aspx">
                        <div class="stat-box">
                            <div class="title">Pending</div>
                            <div class="value text-success">Cases</div>
                        </div>
                    </a>
                ...
                <div class="col-6">
                    <a href="app-User-Master.aspx">
                        <div class="stat-box">
                            ...
                            <div class="value text-primary">Cases</div>
                        </div>
                    </a>
                </div>
                <div class="col-6">
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <a href="app-User-Master.aspx">
                        <div class="stat-box">
                            <div class="title">Pending</div>
                            <div class="value text-warning">Payout</div>
                        </div>
                    </a>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    <a href="app-User-Master.aspx">
                        <div class="stat-box">
                            ...
                            <div class="value text-danger">Finance</div>
                        </div>
                    </a>
                </div>
                <div class="col-6">
                    <a href="app-User-Master.aspx">
                        <div class="stat-box">
                            ...
                            <div class="value text-danger">Cases</div>
                        </div>
                    </a>
                </div>
            </div>
