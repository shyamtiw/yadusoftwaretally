                    ...
                    <div class="wallet-footer">
                        ...
                        <asp:Repeater runat="server" ID="Repeater3">
                            <ItemTemplate>
                                ...
                                <div class="item">
                                    <a href="MSIL_Receivable.aspx?Region=<%# Eval("Region")  %>" class="item">
                        ...
                        <asp:Repeater runat="server" ID="Repeater2">
                            <ItemTemplate>
                                <div class="col-md-6" style="padding-bottom: 5px!important">
                                    <a href="<%# string.IsNullOrWhiteSpace(Request.QueryString["Region"])?"#":string.Concat("Receivable_Detail_Page.aspx?Region=",Request.QueryString["Region"].ToString(),"&&Schemename=",Eval("SchemeName")) %>" class="item">
                                        <div class="stat-box">
