<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app-Discount_Approval.aspx.cs" Inherits="WebApp.mobile.app_Discount_Approval" %>
...
<body class="bg-white">
    ...
    <form runat="server" id="FinancePag1">
        ...
        <div class="appHeader">
            <div class="left">
                <a href="app-transaction-detail.aspx<%= WebApp.LIBS.Common.ConvertInt(Request.QueryString["BookingId"])>0?"?BookingId="+Request.QueryString["BookingId"].ToString():"?BookingApprovalHistoryId="+Request.QueryString["BookingApprovalHistoryId"].ToString() %>" class="headerButton">
                    <ion-icon name="chevron-back-outline"></ion-icon>
                </a>
            </div>
            <div class="pageTitle">
                <div>Discount Approval Request   </div>
                <div>
                    BKG No : -
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <asp:DropDownList runat="server" ID="EmployeeName" CssClass="form-control custom-select" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ForeColor="Red" Font-Bold="true" Font-Size="Smaller" InitialValue="Select" ControlToValidate="EmployeeName" ValidationGroup="ok" runat="server" ErrorMessage="Please input"></asp:RequiredFieldValidator>
                                ...
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        <label class="label" for="text4b">Reason for Request</label>
