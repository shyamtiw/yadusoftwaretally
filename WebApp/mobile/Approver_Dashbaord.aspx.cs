...
{
    public partial class Approver_Dashbaord : BasePageClassMobile
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dt = MobileSales.ApproverDashboardData();

                Send_for_Recommendation.Text = dt.Rows[0]["Send_for_Recommendation"].ToString();
                Pending_For_Approval.Text = dt.Rows[0]["Pending_For_Approval"].ToString();
                Discount_Approved.Text = dt.Rows[0]["Discount_Approved"].ToString();
                Discount_Rejected.Text = dt.Rows[0]["Discount_Rejected"].ToString();

                Send_for_Recommendation1.Text = dt.Rows[0]["Send_for_Recommendation"].ToString();
                Pending_For_Approval1.Text = dt.Rows[0]["Pending_For_Approval"].ToString();
                Discount_Approved1.Text = dt.Rows[0]["Discount_Approved"].ToString();
                Discount_Rejected1.Text = dt.Rows[0]["Discount_Rejected"].ToString();


                username.Text = SiteSession.EmployeeMaster.EmployeeName;
